...
(async () => {
  ...
  for(const report of ['decisions','questions','sources','deployment','denn','market-quality','macro-data','positioning','policy-events','event-alignment','baseline-experiments','causal-graph','interaction-experiments','readiness-review','acquisition-review','data-coverage']) {
  ...
  await page.setViewportSize({width:390,height:844});
  await page.goto('http://192.168.88.5:8088/reports/data-coverage',{waitUntil:'networkidle'});
