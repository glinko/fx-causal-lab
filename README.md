...
Версия 0.10.0: M7 добавляет два leakage-aware описательных среза — event occurrence × CFTC positioning regime и event occurrence × trailing EUR/USD trend. 181 feature row даёт 88 regime × horizon summaries; surprise-interactions и другие отсутствующие гипотезы остаются отдельными unavailable requirements.
