...
- Block permutation importance (один общий перенос строк на все колонки блока; 1d): rates **+3.49%** MSE, energy +1.22%, fx_state +0.71%, risk +0.04% — модель больше всего опирается на rates-блок как на единицу.
